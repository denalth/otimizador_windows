// Autoria: @denalth
// Program.cs - Windows Optimizer v6.0.3
...
class SplashScreen : Form
{
    ...
    public SplashScreen()
    {
        ...
        lblVersion = new Label { Text = "v6.0.3 by @denalth", Font = new Font("Segoe UI", 10, FontStyle.Italic), ForeColor = Color.FromArgb(0, 120, 215), AutoSize = true, Location = new Point(130, 95) };
...
class MainForm : Form
{
    public MainForm()
    {
        this.Text = "Windows Optimizer v6.0.3";
        ...
        Label lblFooter = new Label { Text = "Powered by @denalth | v6.0.3", Font = new Font("Segoe UI", 8), ForeColor = Color.Gray, AutoSize = true, Location = new Point(150, 280) };
